...
# dog trunk base, lower legs, and arm links.  With fixed joints collapsed, the arm mount/base_link
# collision geometry is folded into the dog trunk body named "base", so base_link is not a valid body.

...
class RoboDuetArmPrivilegedObsCfg(ObsGroup):
    ...
    ee_quat_in_base = ObsTerm(
        func=mdp.roboduet_privileged_ee_quat_in_base,
        params={"asset_cfg": SceneEntityCfg("robot", body_names=["link6"])},
    )
...
class UnitreeGo2ArmRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    roboduet_stage2_omni_reward: bool = False
    ...
    def __post_init__(self):
        ...
        # Match upstream Isaac Gym RoboDuet training semantics:
        # - fixed joints collapsed
        # - `cfg.asset.self_collisions = 0` means self-collision enabled there
        # - PhysX solver iterations come from cfg.sim.physx = 4/1
        ...
        roboduet_reward_params = {
            ...
            "roboduet_stage2_omni_reward": self.roboduet_stage2_omni_reward,
